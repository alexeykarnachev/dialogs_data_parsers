...
def _parse_args():
    ...
    parser.add_argument(
        '--start_day', type=str, required=False, default='01-09-2010',
        help='Stories to crawl start day (%d-%m-%Y).'
    )
    parser.add_argument(
        '--end_day', type=str, required=False, default=_get_default_end_day(),
    ...
    parser.add_argument(
        '--pikabu_section', type=str, required=False, default='best',
        help='Pikabu section to crawl.'
    )
